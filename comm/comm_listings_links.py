...
for num in range(1,26):
    url = 'https://www.commercialguru.com.sg/find-commercial-properties/property-for-rent/' + str(num) 
        ...
        for page in glob.glob('*.html'):
            ...
            with open(page) as html_file:
                ...
                for listing_link in listings_links:
                    ...
                    with open("comm_listings_links.csv", 'a') as csv_file:
                        csv_writer = writer(csv_file)
                        csv_writer.writerow([str(rowid), link, ofor, title, address, floor_area, price, psf, availability, listed_on])
