...
with open('landed_listings_links.csv', 'r') as data_csv:
    ...
    # try:
        ...
        try:
            for page in glob.glob('*.html'):
                ...
                with open("landed-listings.csv", 'a') as csv_file:
                    csv_writer = writer(csv_file)

                    csv_writer.writerow([id, link,  ofor, title, address, dist, category, tenure, yearbuilt, floor_size,
                    land_size, price, psf, bed, bath, storeys, furnish, availability, description, listed_on,
                    status, cea_reg, agent_id])


                with open("landed-listings_img.csv", 'a') as csv_file:
                    csv_writer = writer(csv_file)
                ...
                with open("landed-listings_tag.csv", 'a') as csv_file:
                    csv_writer = writer(csv_file)
