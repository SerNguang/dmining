...
with open('landedlinks.csv', 'r') as data_csv:
...
####################################################################################################################
            ...
            with open("landedinfo.csv", 'a') as csv_file:
                csv_writer = writer(csv_file)
                csv_writer.writerow([id, url, project, address, slug, dist, tenure,
                built_year, developer, description])


            with open("landed_pics.csv", 'a') as csv_file:
                csv_writer = writer(csv_file)
            ...
            with open("landed_building.csv", 'a') as csv_file:
                csv_writer = writer(csv_file)
