...
with open("landedinks.csv", 'a') as csv_file:
    ...
    for num in range(1,41):
        url = 'https://www.propertyguru.com.sg/condo-directory/search-project/' + str(num) + '?market=residential&newProject=all&property_type=L&property_type_code%5B0%5D=BUNG&property_type_code%5B1%5D=CON&property_type_code%5B2%5D=CORN&property_type_code%5B3%5D=DETAC&property_type_code%5B4%5D=LBUNG&property_type_code%5B5%5D=LCLUS&property_type_code%5B6%5D=RLAND&property_type_code%5B7%5D=SEMI&property_type_code%5B8%5D=SHOPH&property_type_code%5B9%5D=TERRA&property_type_code%5B10%5D=TOWN'
